...
@echo -e ${CL_GRN}"$($(PRIVATE_PREFIX)DISPLAY) ObjC: $(PRIVATE_MODULE) <= $<"${CL_RST}
...
define transform-host-cpp-to-o
@echo -e ${CL_YLW}"$($(PRIVATE_PREFIX)DISPLAY) C++: $(PRIVATE_MODULE) <= $<"${CL_RST}
@mkdir -p $(dir $@)
...
@echo -e ${CL_YLW}"$($(PRIVATE_PREFIX)DISPLAY) ObjC: $(PRIVATE_MODULE) <= $<"${CL_RST}
...
@echo -e ${CL_GRN}"$($(PRIVATE_PREFIX)DISPLAY) StaticLib: $(PRIVATE_MODULE) ($@)"${CL_RST}
@mkdir -p $(dir $@)
@rm -f $@ $@.tmp
...
@echo -e ${CL_YLW}"$($(PRIVATE_PREFIX)DISPLAY) StaticLib: $(PRIVATE_MODULE) ($@)"${CL_RST}
@mkdir -p $(dir $@)
@rm -f $@ $@.tmp
...
@echo -e ${CL_YLW}"$($(PRIVATE_PREFIX)DISPLAY) SharedLib: $(PRIVATE_MODULE) ($@)"${CL_RST}
@mkdir -p $(dir $@)
$(transform-host-o-to-shared-lib-inner)
endef

define transform-host-o-to-package
@echo -e ${CL_YLW}"$($(PRIVATE_PREFIX)DISPLAY) Package: $(PRIVATE_MODULE) ($@)"${CL_RST}
@mkdir -p $(dir $@)
$(transform-host-o-to-shared-lib-inner)
endef
...
@echo -e ${CL_GRN}"$($(PRIVATE_PREFIX)DISPLAY) SharedLib:$(PRIVATE_MODULE) ($@)"${CL_RST}
@mkdir -p $(dir $@)
...
@echo -e ${CL_GRN}"$($(PRIVATE_PREFIX)DISPLAY) Strip: $(PRIVATE_MODULE) ($@)"${CL_RST}
@mkdir -p $(dir $@)
...
@echo -e ${CL_GRN}"$($(PRIVATE_PREFIX)DISPLAY) Strip (keep symbols): $(PRIVATE_MODULE) ($@)"${CL_RST}
@mkdir -p $(dir $@)
...
@echo -e ${CL_GRN}"$($(PRIVATE_PREFIX)DISPLAY) Executable: $(PRIVATE_MODULE) ($@)"${CL_RST}
@mkdir -p $(dir $@)
...
@echo -e ${CL_GRN}"$($(PRIVATE_PREFIX)DISPLAY) StaticExecutable: $(PRIVATE_MODULE) ($@)"${CL_RST}
@mkdir -p $(dir $@)
...
@echo -e ${CL_YLW}"$($(PRIVATE_PREFIX)DISPLAY) Executable: $(PRIVATE_MODULE) ($@)"${CL_RST}
@mkdir -p $(dir $@)
...
@echo -e ${CL_GRN}"$($(PRIVATE_PREFIX)DISPLAY) Java: $(PRIVATE_MODULE) ($(PRIVATE_CLASS_INTERMEDIATES_DIR))"${CL_RST}
...
@echo -e ${CL_YLW}"$($(PRIVATE_PREFIX)DISPLAY) Java: $(PRIVATE_MODULE) ($(PRIVATE_CLASS_INTERMEDIATES_DIR))"${CL_RST}
...
@echo -e "$($(PRIVATE_PREFIX)DISPLAY) " ${CL_CYN}"Prebuilt: $(PRIVATE_MODULE) ($@)"${CL_RST}
$(copy-file-to-target)
endef
...
@echo -e ${CL_GRN}"$($(PRIVATE_PREFIX)DISPLAY) Generated: $(PRIVATE_MODULE) <= $<"${CL_RST}
@mkdir -p $(dir $@)
